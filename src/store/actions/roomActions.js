import { rejectFriendInvitation, sendFriendInvitation } from "../../api";

export const roomActions ={
    OPEN_ROOM: "ROOM.OPEN_ROOM",
    SET_ROOM_DEATILS: "ROOM.SET_ROOM_DETAILS",
...
export const setRoomsStreams = (remoteStreams) =>{
    return{
...
export const setIsUserJoinedOnlyWithAudio = (onlyWithAudio) =>{
    return{
        ...
        isUserJoinedWihOnlyAudio: onlyWithAudio,
    };
};